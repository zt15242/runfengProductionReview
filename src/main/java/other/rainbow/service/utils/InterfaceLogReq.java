...
import other.rainbow.service.pojo.CustomException;
import other.rainbow.service.pojo.StrUtils;
...
/**
 * @Author：lijinhuan
 * @Package：other.rainbow.invoice.utils
 * @Project：invoice
 * @name：InterfaceLogReq
 * @Date：2024/12/16 23:54
 * @Filename：InterfaceLogReq
 * @email:593356771@qq.com
 */
public class InterfaceLogReq {
    ...
    public static Long insertInterfaceLog(String className,
        ...
        OperateResult insertLog = XObjectService.instance().insert(InterfaceLog);
